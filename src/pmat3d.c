...
//    for (int i = 0 ; i < 4 ; ++i) {
//        printf("%f %f %f %f \n", worldToCan[i * 4], worldToCan[i * 4 + 1], worldToCan[i * 4 + 2], worldToCan[i * 4 + 3]);
//    }
//    for (int i = 0 ; i < 4 ; ++i) {
//        printf("%f %f %f %f \n", canToWorld[i * 4], canToWorld[i * 4 + 1], canToWorld[i * 4 + 2], canToWorld[i * 4 + 3]);
//    }
//    for (int i = 0 ; i < 4 ; ++i) {
//        printf("%f %f %f %f \n", othis->worldToCan[i * 4], othis->worldToCan[i * 4 + 1], othis->worldToCan[i * 4 + 2], othis->worldToCan[i * 4 + 3]);
//    }
//    for (int i = 0 ; i < 4 ; ++i) {
//        printf("%f %f %f %f \n", othis->canToWorld[i * 4], othis->canToWorld[i * 4 + 1], othis->canToWorld[i * 4 + 2], othis->canToWorld[i * 4 + 3]);
//    }
    ...
    printf("%p %p %p %p \n", &distance3D, othis->distance, &distanceGeoCube, othis->distanceGeo);
