...
{ 
  ...
  g2x_SetWindowCoord(xmin,ymin,xmax,ymax);
	...
	g2x_CreateScrollh_d("h",&h,0.0001,.1  ,  4.,"sampling rate  ");	
	g2x_CreateScrollh_d("k",&k,0.    ,1.e+4, 2.,"spring stiffness");
	g2x_CreateScrollh_d("z",&z,0.    ,1.e+1, 2.,"damper viscosity");
	g2x_CreateScrollv_d("xmax",&xamp ,.05,50.,1.,"xmax");
	g2x_CreateScrollv_d("yamp",&yamp ,.01,1.0,1.,"yamp");
